...
//   void editExpense(ExpenseEntry expense) {
//     showDialog(
//       context: context,
...
//             children: [
//               _buildCategoryDropdown('Category', expense.category),
//               _buildTextField('Description', descriptionController..text = expense.description),
//               _buildAmountField('Amount', amountController..text = expense.amount.toString()),
//             ],
//           ),
//           actions: [
//             TextButton(
